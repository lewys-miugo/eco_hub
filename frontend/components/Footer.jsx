...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#163466] border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">EcoPower Hub</h3>
            <p className="text-gray-300 text-sm mb-4">
              Your Smart Solar Assistant & Local Energy Marketplace
            </p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} EcoPower Hub. All rights reserved.
          </p>
          <p className="text-gray-400 text-sm mt-2 md:mt-0">
            Powered by renewable energy ♻️
          </p>
        </div>
      </div>
    </footer>
